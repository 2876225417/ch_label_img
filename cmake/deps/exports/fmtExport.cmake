...
pretty_message(INFO "Loading fmt export configuration")
...
foreach(path ${FMT_POSSIBLE_PATHS})
    ...
    if (EXISTS "${config_path}/fmt-config.cmake")
        pretty_message(SUCCESS "Found fmt config at: ${config_path}")
        list(APPEND CMAKE_PREFIX_PATH ${path})
        find_package(fmt QUIET CONFIG PATHS ${path} NO_DEFAULT_PATH)
        if (fmt_FOUND)
            pretty_message(SUCCESS "✓ fmt loaded from ${path}")
            pretty_message(SUCCESS "✓ fmt version: ${fmt_VERSION}")
            break()
        endif()
    endif()
endforeach()

...
function(dependency_manager_init)
    pretty_message(INFO "Initializing Dependency Manager")
    pretty_message(INFO "  - Default strategy:  ${DEFAULT_FIND_STRATEGY}")
    pretty_message(INFO "  - 3rdparty root:     ${DEPENDENCY_ROOT_DIR}")
    pretty_message(INFO "  - Export directory:  ${DEPENDENCY_EXPORTS_DIR}")
...
function(find_dependency dep_name)
    ...
    pretty_message(INFO "Finding ${dep_name} using strategy: ${strategy}")
...
function(_find_dependency_manual dep_name out_found)
    ...
    pretty_message(INFO "Using manual path for ${dep_name}: ${manual_path}")
...
function(_find_dependency_local dep_name out_found)
    ...
    if (EXISTS ${export_file})
        pretty_message(INFO "Using export file: ${export_file}")
        include(${export_file})
